...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name, subgenres.name FROM authors LEFT JOIN series ON series.author_id = authors.id LEFT JOIN subgenres ON series.subgenre_id = subgenres.id;"
end
